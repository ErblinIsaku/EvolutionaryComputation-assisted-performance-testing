...
//        }
  ...
  */  
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    for (int i = 0; i < particlesSize_; i++){
      Solution particle = new Solution(problem_, WorkloadList);
      ((LoadTesting)problem_).evaluate(particle, WorkloadList);
//      ((LoadTesting)problem_).evaluateConstraints(particle);
