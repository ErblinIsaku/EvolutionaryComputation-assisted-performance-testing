...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("SBXSinglePointCrossover"))
      return new SBXSinglePointCrossover(parameters);
    ...
    else if (name.equalsIgnoreCase("TripleTwoPointsCrossOver"))
        return new TripleTwoPointsCrossOver(parameters);
    else {
