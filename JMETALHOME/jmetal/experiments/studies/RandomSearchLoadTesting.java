 ...
 * @author Erblin
 */
public class RandomSearchLoadTesting extends Experiment{
    @Override
    public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException
    {
        try {
            ...
            algorithm[0] = new RandomSearch_Settings(problemName).configure(parameters[0]);
//            algorithm[1] = new SPEA2_Settings(problemName).configure(parameters[1]);

        }
        catch(IllegalArgumentException ex){
            Logger.getLogger(RandomSearchLoadTesting.class.getName()).log(Level.SEVERE, null,ex );
        }
    ...
    public static void main ( String [ ] args ) throws JMException , IOException {
        ...
        RandomSearchLoadTesting exp = new RandomSearchLoadTesting( );
        exp.experimentName_ = "RandomSearchLoadTesting";

        exp.algorithmNameList_ = new String[ ] {"RandomSearch"} ;
//
