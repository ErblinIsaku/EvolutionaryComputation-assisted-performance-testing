 ...
 * @author Erblin
 */
public class SPEA2LoadTesting extends Experiment{
    @Override
    public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException
    {
        try {
            ...
            algorithm[0] = new SPEA2_Settings(problemName).configure(parameters[0]);

        }
        catch(IllegalArgumentException ex){
            Logger.getLogger(SPEA2LoadTesting.class.getName()).log(Level.SEVERE, null,ex );
        }
    ...
    public static void main ( String [ ] args ) throws JMException , IOException {
        ...
        SPEA2LoadTesting exp = new SPEA2LoadTesting( );
        exp.experimentName_ = "SPEA2LoadTesting";

        exp.algorithmNameList_ = new String[ ] {"SPEA2"} ;
//
