 ...
 * @author Erblin
 */
public class PAESLoadTesting extends Experiment{
    @Override
    public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException
    {
        try {
            ...
            Logger.getLogger(PAESLoadTesting.class.getName()).log(Level.SEVERE, null,ex );
        }
    ...
    public static void main ( String [ ] args ) throws JMException , IOException {
        ...
        PAESLoadTesting exp = new PAESLoadTesting( );
        exp.experimentName_ = "PAESLoadTesting";
