...
import jmetal.experiments.settings.NSGAIIAdaptive_Settings;
 ...
 */
public class WaterStudy extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
      ...
      algorithm[0] = new NSGAIIAdaptive_Settings(problemName).configure(parameters[0]);
...
//      algorithm[2] = new GDE3_Settings(problemName).configure(parameters[2]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    WaterStudy exp = new WaterStudy();

    exp.experimentName_ = "WaterStudy";
    exp.algorithmNameList_ = new String[]{
        "NSGAIIAdaptive"};
    exp.problemList_ = new String[]{"Water"};
    exp.paretoFrontFile_ = new String[]{"Water.pf"};
...
//    exp.paretoFrontDirectory_ = "/Users/antelverde/Softw/pruebas/data/paretoFronts";
    ...
    rows = 3 ;
    columns = 2 ;
    prefix = new String("WaterStudy");
    problems = new String[]{"Water"} ;
