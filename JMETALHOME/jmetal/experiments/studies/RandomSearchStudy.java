 ...
 * @author Mahshid
 */
public class RandomSearchStudy extends Experiment {
    ...
    public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException
    {
      try {
        ...
        algorithm[0] = new RandomSearch_Settings(problemName).configure(parameters[0]);
          ...
          Logger.getLogger(RandomSearchStudy.class.getName()).log(Level.SEVERE, null,ex );
      }
    ...
    RandomSearchStudy exp = new RandomSearchStudy( );
    exp.experimentName_ = "RandomSearchStudy";
