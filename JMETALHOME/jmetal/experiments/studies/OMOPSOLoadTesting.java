 ...
 * @author Erblin
 */
public class OMOPSOLoadTesting extends Experiment{
    @Override
    public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm) throws ClassNotFoundException
    {
        try {
            ...
            algorithm[0] = new OMOPSO_Settings(problemName).configure(parameters[0]);

        }
        catch(IllegalArgumentException ex){
            Logger.getLogger(OMOPSOLoadTesting.class.getName()).log(Level.SEVERE, null,ex );
        }
    ...
    public static void main ( String [ ] args ) throws JMException , IOException {
        ...
        OMOPSOLoadTesting exp = new OMOPSOLoadTesting( );
        exp.experimentName_ = "OMOPSOLoadTesting";

        exp.algorithmNameList_ = new String[ ] {"OMOPSO"} ;
//
