...
public class QLearning{
    ...
    private  stateAction[][] Qtable = new stateAction[12][];
...
//        if (prev_SUT_state.qualityMeasures.errorRate > curr_SUT_state.qualityMeasures.errorRate || prev_SUT_state.qualityMeasures.responseTime > curr_SUT_state.qualityMeasures.responseTime)
