...
public class CsvWriter {
    ...
    CsvWriter(String filePath, String fileTitle,int maxResponseTimeThreshold, Double maxErrorRateThreshold, int episodeExecutionDelay,double learningRate, double discountFactor){
      ...
      String columns = "episode,episodeStep,StepReply,responseTime,errorRate,totalWorkload,agentState,epsilon,learningRate,HomePage,RegisterPage,RegisterUser,BrowsePage,BrowseInCategory,BrowseInRegions,SellPage,SellItem,AboutMePage,AboutMeUser,BidOnItem, SellItem\n";
     ...
     CsvWriter(String filePath, String fileTitle,int maxResponseTimeThreshold, Double maxErrorRateThreshold, int episodeExecutionDelay){
      ...
      String columns = "episode,episodeStep,StepReply,responseTime,errorRate,totalWorkload,HomePage,RegisterPage,RegisterUser,BrowsePage,BrowseInCategory,BrowseInRegions,SellPage,SellItem,AboutMePage,AboutMeUser,BidOnItem, SellItem\n";
      String str = str1+columns;
      writeString(str, fullLogFileName);   
